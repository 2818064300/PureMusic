...
import com.lie.puremusic.databinding.FragmentSquare1Binding
import jp.wasabeef.recyclerview.adapters.AlphaInAnimationAdapter

class SquareFragment1 : Fragment() {
    private var _binding: FragmentSquare1Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSquare1Binding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = context?.let { StaticData.Square.get(0)?.getSongsLists()?.let { it1 -> MyRecyclerGridAdapter(it, it1, 2) } }
