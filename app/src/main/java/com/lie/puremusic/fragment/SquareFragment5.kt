...
import com.lie.puremusic.databinding.FragmentSquare5Binding
import jp.wasabeef.recyclerview.adapters.AlphaInAnimationAdapter

class SquareFragment5 : Fragment() {
    private var _binding: FragmentSquare5Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSquare5Binding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = context?.let { StaticData.Square.get(4)?.getSongsLists()?.let { it1 -> MyRecyclerGridAdapter(it, it1, 2) } }
