...
import com.lie.puremusic.databinding.FragmentSquare4Binding
import jp.wasabeef.recyclerview.adapters.AlphaInAnimationAdapter

class SquareFragment4 : Fragment() {
    private var _binding: FragmentSquare4Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSquare4Binding.inflate(inflater, container, false)
        return binding.root
...
//        val adapter = context?.let { StaticData.Square.get(3)?.getSongsLists()?.let { it1 -> MyRecyclerGridAdapter(it, it1, 2) } }
