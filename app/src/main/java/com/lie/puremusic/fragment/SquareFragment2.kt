...
import com.lie.puremusic.databinding.FragmentSquare2Binding
import jp.wasabeef.recyclerview.adapters.AlphaInAnimationAdapter

class SquareFragment2 : Fragment() {
    private var _binding: FragmentSquare2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSquare2Binding.inflate(inflater, container, false)
        return binding.root
